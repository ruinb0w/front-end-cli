...
exports.generateHookCommand = generateHookCommand;
const chalk_1 = __importDefault(require("chalk"));
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const file_1 = require("../utils/file");
const hook_1 = require("../templates/hook");
async function generateHookCommand(storeName) {
    const projectRoot = (0, file_1.findProjectRoot)(process.cwd());
    const storesDir = path_1.default.join(projectRoot, 'src', 'hooks');
    ...
    try {
        ...
        if (!fs_1.default.existsSync(storeFilePath)) {
            const storeContent = (0, hook_1.generateHookTemplate)(storeName);
