...
exports.generateComCommand = generateComCommand;
const chalk_1 = __importDefault(require("chalk"));
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const file_1 = require("../utils/file");
const component_1 = require("../templates/component");
async function generateComCommand(componentName) {
    ...
    if (!pascalCaseRegex.test(componentName)) {
        console.error(chalk_1.default.red(`Error: Component name "${componentName}" must be in PascalCase (e.g., AbcDef)`));
        process.exit(1);
    }
    const projectRoot = (0, file_1.findProjectRoot)(process.cwd());
    const viewsDir = path_1.default.join(projectRoot, 'src', 'components');
    ...
    try {
        ...
        if (!fs_1.default.existsSync(componentFilePath)) {
            ...
            const componentContent = (0, component_1.generateComTemplate)(kebabCaseName);
